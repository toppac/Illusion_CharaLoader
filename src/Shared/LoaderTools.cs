...
namespace CharaLoader
{
        ...
        public static long GetPngSize(BinaryReader br)
        {
            ...
            try
            {
                if (br.ReadInt64() == PNG_IDTT)
                {
                    for (; ; )
                    {
                        var chunk = Big2LittleInt32(br.ReadInt32());
    ...
    public static class ReadFileInfo
    {
        ...
        public static bool LoadFile(BinaryReader br, CharaItem item)
        {
            ...
            try
            {
                /*if (dataPos != 0L)
                {
                    var by = new byte[dataPos];
                    if (br.BaseStream.Read(by, 0, dataPos) == 0)
                        item.PngData = by;
                }*/
    ...
    public static class CharaTools
    {
        ...
        public static Type StudioCharaListUtilType {
            get
            {
                ...
                return _studioCharaListUtilType ?? (
                    _studioCharaListUtilType = Type.GetType(
                        "WearCustom.StudioCharaListUtil, " +
                        "HS2WearCustom, Version=0.4.0.0, " +
                        "Culture=neutral, PublicKeyToken=null")
                    );
#elif AI
                return _studioCharaListUtilType ?? (Type.GetType("AIWearCustom.StudioCharaListUtil, " +
        ...
        private static void SetBone(List<BoneModifier> bones, ChaControl chaCtrl, bool loadFace, bool loadBody)
        {
            ...
            var headBones = new HashSet<string>(
                headRoot.GetComponentsInChildren<Transform>().Select(x => x.name));
    ...
    public static class HSceneTools
    {
        ...
        public static HScene HSceneIns
            => HSceneManager.instance.Hscene;

        public static bool HSceneLoaded
            => HSceneIns || KKAPI.SceneApi.GetLoadSceneName() == H_SCENE_NAME;

        public static HS2_HCharaSwitcher.HS2_HCharaSwitcher HSwitch
        {
            get { return HS2_HCharaSwitcher.HS2_HCharaSwitcher.instance; }
        }

        public static HSceneFlagCtrl HFlagCtrl => HSceneIns.ctrlFlag;

        public static ChaControl[] SchaMales
        {
            get { return HS2_HCharaSwitcher.HS2_HCharaSwitcher.chaMales; }
        }

        public static ChaControl[] SchaFemales
        {
            get { return HS2_HCharaSwitcher.HS2_HCharaSwitcher.chaFemales; }
        }
